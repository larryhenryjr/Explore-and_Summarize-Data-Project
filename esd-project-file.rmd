...
```{r echo=FALSE, message=FALSE, warning=FALSE, Load_the_Data_Display_Counts}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Load_the_Data_Display_Counts_2}
...
ggplot(data = loandata, aes(x = LoanOriginalAmount, y = BorrowerRate)) +
  geom_point(alpha = 0.1, color = '#425E72')
